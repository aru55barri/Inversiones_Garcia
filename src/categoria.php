...
$id = $_SESSION['rol'];
$sql = mysqli_query($conn, "SELECT * FROM tbl_permisos where ID_OBJETO = 24 and ID_ROL = '$id'");
...
<div class="page-title">
    ...
    <h1 class=" text-center" id="letra"> Categoria </h1>
<style>
h1{
...
font-size: 80px;
        ...
        <div class="title_right">
            ...
            <?php
            if ($insertar == 1) { ?>
                <button onclick="window.location.href='../src/nueva_categoria.php'" class="btn  btn-round btn-success"><i class="fa-solid fa-circle-plus"></i> Nueva Categoria</button>
                <?php } ?>
            </div>
        </div>
    </div>
    ...
    if (isset($_SESSION['eliminarCategoria'])) {
      if ($_SESSION['eliminarPregunta'] == 'Si') {
        echo "<script>Notiflix.Notify.failure('Categoria Eliminada Correctamente');</script>";
      } else {
        echo "<script>Notiflix.Notify.warning('No se pudo eliminar Una Categoria porque esta asociado a un usuario');</script>";
      }
  
      unset($_SESSION['eliminarCategoria']);
    }
    ?>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="table">
                    ...
                    <tbody>
                        ...
                        VALUES(null,'$fecha','$IDUS',24, 'INGRESO','$Usuarioo INGRESÓ A TABLA CATEGORIA')";
...
<script>
    function eliminar(id) {
        ...
        swal.fire({
            ...
            if (result.value) {
                window.location.href = '../Login/eliminarAuxiliar.php?id=' + id + '&tabla=categoria';
            }
        })
