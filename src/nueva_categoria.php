...
$tipocategoria= $categoria ->ListarTipoCategoria();
...
if (!empty($_POST)) {
    ...
    $resultado = InsertarCategoria($descripcion);
            ...
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header" style="background-color: rgb(171, 237, 230);">
                        <b>
                            <h3 class="text-center font-weight-light my-4">Registrar Categoria</h3>
                        </b>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="form-register" class="needs-validation" method="POST" >
                          ...
                          <div class="form-floating mb-3">                      
                                <select name="cliente" id="cliente" class="form-control" required="true">
                                        <option value="">Seleccione un Tipo de Categoria</option>
                                        <?php while ($row = $tipocategoria->fetch()) { ?>
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" name="txtdescripcion" id="txtdescripcion" type="text" onkeypress="return solonumeros(event)" autocomplete="nope" placeholder="Ingrese el nombre del proveedor" required maxlength="8" />
                                <label for="inputEmail"><i class="fa-solid fa-mobile-screen"></i>&nbsp;Descripcion</label>
