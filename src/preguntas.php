...
$id = $_SESSION['rol'];
$sql = mysqli_query($conn, "SELECT * FROM tbl_permisos where ID_OBJETO = 27 and ID_ROL = '$id'");
...
font-size: 80px;
        ...
        <div class="title_right">
            ...
            <?php
            if ($insertar == 1) { ?>
                <button onclick="window.location.href='../src/nueva_pregunta.php'" class="btn  btn-round btn-success"><i class="fa-solid fa-circle-plus"></i> Nueva Pregunta</button>
                <?php } ?>
            </div>
        </div>
    </div>
    ...
    if (isset($_SESSION['eliminarPregunta'])) {
      ...
      unset($_SESSION['eliminarPregunta']);
    }
    ?>
                ...
                <table class="table table-striped table-bordered" id="table">
                    ...
                    <tbody>
                        ...
                        foreach ($resultado as $Pregunta) {
                            ...
                            //CAMBIOS
                            if ($modificar == 1) { 
                              echo "<th><a href='../src/modificar_pregunta.php?id=" . base64_encode($Pregunta['id_pregunta']) . "'> <i class='btn btn-round btn-info'><i class='fa-solid fa-pen-to-square'></i></a></th>";
                            }
                            ...
                            echo "<td><button class ='btn btn-round btn-danger' onclick='eliminar(" . $Pregunta['id_pregunta'] . ")'><i class='fas fa-trash-alt'></i></button></td>";
                            }
                            echo "</tr>";
                        }
                        ...
                        VALUES(null,'$fecha','$IDUS',27, 'INGRESO','$Usuarioo INGRESÓ A TABLA PREGUNTAS')";
