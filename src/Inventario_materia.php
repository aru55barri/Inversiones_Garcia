...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
            ...
            <h1 class=" text-center" id="letra"> Inventario Materia Prima </h1>
                       <style>
                        h1{
          ...
          <div class="modal-dialog " role="document">
            <div class="modal-content">
              <div class="modal-header bg-primary text-white" >
                <h5 class="modal-title"  id="exampleModalScrollableTitle">Nueva Materia Prima  </h5>
        ...
        <tbody>
          ...
          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalScrollablesl">Agregar  <i class='fa fa-tag'></i></button> <br><br>
...
<div class="modal-dialog " role="document">
  <div class="modal-content">
    <div class="modal-header bg-danger text-white" >
      <h5 class="modal-title"  id="exampleModalScrollableTitle">Agregar Materia Prima </h5>
      <button type="button"  class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-primary">Aceptar</button>
            ...
            <tr>
                ...
                <button class="btn btn-danger" type="submit">Agregar<i class="fa fa-tag"></i> </button>
                </form><br><br>
            </tr>
